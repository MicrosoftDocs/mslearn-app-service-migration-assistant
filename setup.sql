...
CREATE NONCLUSTERED INDEX [IX_CateryId] ON [dbo].[Products] ([CateryId])
...
(
[CateryId] [int] NOT NULL IDENTITY(1, 1),
[Name] [nvarchar] (max) NOT NULL,
[Description] [nvarchar] (max) NULL,
[ImageUrl] [nvarchar] (max) NULL
)
ALTER TABLE [dbo].[Cateries] ADD CONSTRAINT [PK_dbo.Cateries] PRIMARY KEY CLUSTERED  ([CateryId])
...
ALTER TABLE [dbo].[Products] ADD CONSTRAINT [FK_dbo.Products_dbo.Cateries_CateryId] FOREIGN KEY ([CateryId]) REFERENCES [dbo].[Cateries] ([CateryId]) ON DELETE CASCADE
...
ALTER TABLE [dbo].[Rainchecks] ADD CONSTRAINT [FK_dbo.Rainchecks_dbo.Stores_StoreId] FOREIGN KEY ([StoreId]) REFERENCES [dbo].[Stores] ([StoreId]) ON DELETE CASCADE
	...
	INSERT INTO [dbo].[Cateries] ([CateryId], [Name], [Description], [ImageUrl]) VALUES (1, N'Brakes', N'Brakes description', N'product_brakes_disc.jpg')
	INSERT INTO [dbo].[Cateries] ([CateryId], [Name], [Description], [ImageUrl]) VALUES (2, N'Lighting', N'Lighting description', N'product_lighting_headlight.jpg')
	INSERT INTO [dbo].[Cateries] ([CateryId], [Name], [Description], [ImageUrl]) VALUES (3, N'Wheels & Tires', N'Wheels & Tires description', N'product_wheel_rim.jpg')
	INSERT INTO [dbo].[Cateries] ([CateryId], [Name], [Description], [ImageUrl]) VALUES (4, N'Batteries', N'Batteries description', N'product_batteries_basic-battery.jpg')
	INSERT INTO [dbo].[Cateries] ([CateryId], [Name], [Description], [ImageUrl]) VALUES (5, N'Oil', N'Oil description', N'product_oil_premium-oil.jpg')
	SET IDENTITY_INSERT [dbo].[Cateries] OFF



	SET IDENTITY_INSERT [dbo].[Products] ON
	INSERT INTO [dbo].[Products] ([ProductId], [SkuNumber], [CateryId], [RecommendationId], [Title], [Price], [SalePrice], [ProductArtUrl], [Description], [Created], [ProductDetails], [Inventory], [LeadTime]) VALUES (1, N'LIG-0001', 2, 1, N'Halogen Headlights (2 Pack)', CAST(38.99 AS Decimal(18, 2)), CAST(38.99 AS Decimal(18, 2)), N'product_lighting_headlight.jpg', N'Our Halogen Headlights are made to fit majority of vehicles with our  universal fitting mold. Product requires some assembly and includes light bulbs.', N'2017-09-14 13:28:10', N'{ "Light Source" : "Halogen", "Assembly Required": "Yes", "Color" : "Clear", "Interior" : "Chrome", "Beam": "low and high", "Wiring harness included" : "Yes", "Bulbs Included" : "No",  "Includes Parking Signal" : "Yes"}', 10, 0)
	...
	INSERT INTO [dbo].[Products] ([ProductId], [SkuNumber], [CateryId], [RecommendationId], [Title], [Price], [SalePrice], [ProductArtUrl], [Description], [Created], [ProductDetails], [Inventory], [LeadTime]) VALUES (8, N'WHE-0005', 3, 8, N'Chrome Rim Tire Combo', CAST(129.99 AS Decimal(18, 2)), CAST(129.99 AS Decimal(18, 2)), N'product_wheel_tyre-rim-chrome-combo.jpg', N'Save time and money with our ever popular wheel and tire combo. Pre-assembled and ready to .', N'2017-09-14 13:28:10', N'{ "Material" : "Aluminum alloy",  "Design" : "Spoke", "Spokes" : "10",  "Number of Lugs" : "5", "Wheel Diameter" : "17 in.", "Color" : "Silver", "Finish" : "Chrome", "Pre-Assembled" : "Yes" } ', 1, 0)
